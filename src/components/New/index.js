...
import { MDCTextField, MDCTextFieldFoundation } from '@material/textfield'; // textfield for custom input mask
    ...
    render() {
        ...
        return(
            <div className="places-details">
                <h2 className="mdc-typography--title page-title">Нова точка збору</h2>
                ...
                <div className="details-footer">
                    <Button className="details-button" raised onClick={this.onClick}>Створити</Button>
                </div>
